...
export const CORE_PROFILE_FIELDS: UnifiedFieldSpec[] = [
  ...
  { id: "right_to_work", label: "Right to Work in Country of Residence", section: "Basic Profile", type: "boolean", required: true, searchable: true },
  { id: "valid_passport", label: "Hold a Valid Passport", section: "Basic Profile", type: "boolean", required: true, searchable: true },
