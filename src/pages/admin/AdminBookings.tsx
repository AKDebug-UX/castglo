 ...
 const stats = [
   { label: "Total Bookings", value: "89", color: "foreground" },
   { label: "Completed", value: "43", color: "success" },
   { label: "Confirmed", value: "34", color: "primary" },
                 ...
                 <TableRow key={booking.id}>
                   ...
                   <TableCell>
                     <div className="flex justify-end">
                       <Button variant="ghost" size="icon-sm" onClick={() => setSelectedBooking(booking)}>
             ...
             <div className="space-y-4">
               ...
               <div className="flex gap-2 pt-2">
                 ...
                 {selectedBooking.status === "Confirmed" && (
                   <Button variant="success" className="flex-1">Mark Complete</Button>
                 )}
               </div>
             </div>
           )}
