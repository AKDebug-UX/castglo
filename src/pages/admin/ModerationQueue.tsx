 ...
 const stats = [
   { label: "Pending Review", value: "3", sublabel: "Requires immediate attention", icon: AlertTriangle, color: "warning" },
   { label: "Resolved Today", value: "12", sublabel: "Content moderated", icon: CheckCircle, color: "success" },
   { label: "Escalated", value: "2", sublabel: "Needs senior review", icon: XCircle, color: "destructive" },
 ];
