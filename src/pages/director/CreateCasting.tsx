...
export default function CreateCasting() {
  ...
  const handleAutoFill = () => {
    setFormData((prev: any) => ({
      ...
      internal_project_reference: "REF-2024-MH-001",
      ...
      union_details: "",
      project_website: "https://midnightheist.example.com",
      short_project_summary: "A gripping action-thriller about a heist that spirals out of control in the heart of London.",
      full_project_description:
        "Set in modern-day London, 'The Midnight Heist' follows a seasoned detective and a reluctant getaway driver who are unknowingly on the same side of a bank robbery gone wrong. As loyalties shift and the clock ticks down, both must decide who to trust. A fast-paced, character-driven thriller with high production values and an international distribution deal already in place.",
      director_name: "Jane Doe",
      producer_name: "John Doe",
      writer_name: "Jane Smith",
      casting_director_name: "Rachel Green",
      production_notes: "Filming begins Q1 2025. International cast welcome. SAG-AFTRA guidelines followed where applicable.",
      industry_areas: ["Film", "Television"],
      intended_audience_market: "Adult (18+), International",

      // ── Step 2: Talent Needed ────────────────────────────────────────
      talent_types_needed: ["Actor", "Extra"],
      role_scope: "Multiple Roles",
      total_number_of_roles: "3",
      open_to_mixed_talent_categories: true,
      represented_talent_only: false,
      open_to_unrepresented_talent: true,
      talent_location_scope: "International",
      preferred_talent_base: "London, New York",
      ...
      roles: [
        {
          ...
          role_type: ["Lead"],
          role_status: "Open",
          character_role_summary: "A seasoned, sharp-witted detective who never gives up on a case.",
          full_role_description:
            "Detective Morgan is a 10-year veteran of the Met who has seen it all — but nothing prepared them for a heist that implicates their own department. Requires strong dramatic range, confident physical presence, and the ability to portray both vulnerability and authority.",
          number_of_talents_needed: "1",
          featured_role: true,
          role_talent_types_needed: ["Actor"],
          playing_age_range: "30-45",
          minimum_age: "30",
          maximum_age: "45",
          gender: ["Any"],
          ethnicity: [],
          open_to_all_ethnicities: true,
          skills_required: ["Stage Combat", "Driving"],
          preferred_skills: ["Firearms Training", "Improvisation"],
          professional_experience_required: true,
          experience_level_preferred: "Professional",
          speaking_role: true,
          languages_required: ["English"],
          accents_required: ["Standard British", "American"],
          role_city: "London",
          role_country: "UK",
          shoot_dates: "2025-02-10 to 2025-04-20",
          rehearsal_dates: "2025-01-20 to 2025-02-09",
          availability_requirement: "Full availability required for shoot duration.",
          is_paid_role: true,
          ...
          travel_covered: true,
          compensation_notes: "All reasonable expenses covered. Full contract provided.",
      ...
      accept_until_role_filled: false,
      ...
      audition_date: "2025-01-15",
      callback_date: "2025-01-22",
      audition_location: "London, UK (online option available)",
      audition_instructions:
        "Please prepare a 2-minute dramatic monologue and a 1-minute comedic piece. Self-tape submissions must be well-lit with clear audio.",
      self_tape_accepted: true,
      self_tape_deadline: "2025-01-10",
      live_online_audition_available: true,
      interview_required: false,
      interview_format: "Online",

      // ── Step 5: Pre-Audition & Media ─────────────────────────────────
      media_required: ["Headshot", "Reel", "CV"],
      custom_upload_requested: false,
      custom_upload_description: "",
      pre_audition_questions: [
        {
          title: "Do you have any scheduling conflicts in February–April 2025?",
          type: "text",
          required: true,
          help_text: "Please list any known conflicts.",
          sort_order: 1,
        },
        {
          title: "Have you worked on a major film production before?",
          type: "yes_no",
          required: true,
          sort_order: 2,
        },
