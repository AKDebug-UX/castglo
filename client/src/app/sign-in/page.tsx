            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-card rounded-2xl shadow-card p-8">
                    <div className="text-center mb-6">
                        ...
                        <p className="text-muted-foreground mt-1">Sign in to your Castglo account</p>
                    </div>
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            {(["talent", "director", "professional", "admin"] as UserRole[]).map((role) => (
                                <button
                                    ...
                                    className={`px-3 py-2 text-sm rounded-lg border transition-colors capitalize ${selectedRole === role
