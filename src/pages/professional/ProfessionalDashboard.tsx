        ...
        <CardContent>
          {upcomingBookings.length > 0 ? (
            ...
            <div className="text-center py-8 text-muted-foreground space-y-3">
              <p className="text-sm">No upcoming bookings found. Client bookings will appear here automatically.</p>
              <div>
                <Button variant="outline" size="sm" asChild>
                  <Link to="/professional/services">Manage Your Services</Link>
                </Button>
              </div>
            </div>
          )}
