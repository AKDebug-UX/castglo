...
import { API_BASE_URL, profileAPI, castingCallAPI } from "@/lib/api";
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-6 flex flex-col gap-2">
                      <Button variant="hero" className="w-full" asChild>
                        <Link to={`/professional/messages?recipientId=${(profile as any)?.userId?._id || (profile as any)?.userId?.id || id}`}>Message Casting Director</Link>
                      </Button>
