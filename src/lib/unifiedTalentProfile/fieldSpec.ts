...
export const CORE_PROFILE_FIELDS: UnifiedFieldSpec[] = [
  ...
  { id: "right_to_work", label: "Right to Work in Country of Residence", section: "Basic Profile", type: "boolean", required: false, searchable: true },
  { id: "valid_passport", label: "Hold a Valid Passport", section: "Basic Profile", type: "boolean", required: false, searchable: true },
  { id: "willing_to_travel", label: "Willing to Travel for Work", section: "Availability", type: "boolean", required: true, searchable: true },
  { id: "international_availability", label: "Available for International Opportunities", section: "Availability", type: "boolean", required: true, searchable: true },
  { id: "remote_work_open", label: "Open to Remote / Virtual Work", section: "Availability", type: "boolean", required: false, searchable: true },
  ...
  { id: "languages_spoken", label: "Languages Spoken", section: "Basic Profile", type: "multi-select", required: false, searchable: true, optionSource: "languages", validation: "Store as array" },
  ...
  { id: "performance_languages", label: "Performance Languages", section: "Basic Profile", type: "multi-select", required: false, searchable: true, optionSource: "languages", validation: "Store as array" },
  { id: "languages_for_voice_work", label: "Languages for Voice Work", section: "Basic Profile", type: "multi-select", required: false, searchable: true, optionSource: "languages", validation: "Store as array" },
  { id: "languages_for_presentation", label: "Languages for Presentation", section: "Basic Profile", type: "multi-select", required: false, searchable: true, optionSource: "languages", validation: "Store as array" },
...
export const ACTOR_FIELDS = byTalentType("Actor / Performer", [
  { id: "actor_performance_category", label: "Primary Performance Category", section: "Actor Profile", type: "select", required: true, searchable: true, options: ["Screen Actor", "Stage Actor", "Musical Theatre Performer", "Voice Actor", "Dancer-Actor", "Presenter", "Comedian", "Other"] },
  { id: "actor_playing_age_range", label: "Playing Age Range", section: "Actor Profile", type: "select", required: false, searchable: true, options: ["4-7", "8-12", "13-17", "18-24", "25-34", "35-44", "45-54", "55-64", "65+"] },
  { id: "actor_training", label: "Formal Acting / Performance Training", section: "Actor Profile", type: "boolean", required: false, searchable: true },
  { id: "actor_training_school", label: "Drama School / Training Institution", section: "Actor Profile", type: "text", required: false, searchable: true, validation: "Max 200 chars" },
...
export const MODEL_FIELDS = byTalentType("Model", [
  { id: "model_primary_category", label: "Primary Modelling Category", section: "Model Profile", type: "select", required: true, searchable: true, options: ["Fashion", "Commercial", "Editorial", "Runway", "Beauty", "Fitness", "Lifestyle", "E-commerce", "Promotional", "Child Model", "Mature Model", "Petite", "Plus-size", "Parts Model", "Swimwear", "Lingerie", "Other"] },
  { id: "model_additional_categories", label: "Additional Modelling Categories", section: "Model Profile", type: "multi-select", required: false, searchable: true },
  ...
  { id: "model_open_hair_changes", label: "Open to Hair Styling Changes", section: "Model Profile", type: "boolean", required: false, searchable: true },
  { id: "model_open_beauty_campaigns", label: "Open to Beauty Campaigns", section: "Model Preferences", type: "boolean", required: false, searchable: true },
  { id: "model_open_runway", label: "Open to Runway", section: "Model Preferences", type: "boolean", required: false, searchable: true },
  { id: "model_open_swimwear", label: "Open to Swimwear", section: "Model Preferences", type: "boolean", required: false, searchable: true },
  { id: "model_open_lingerie", label: "Open to Lingerie", section: "Model Preferences", type: "boolean", required: false, searchable: true },
  { id: "model_comp_card", label: "Comp Card / Digital Casting Card", section: "Model Media", type: "file", required: false, searchable: false },
  { id: "model_runway_video", label: "Runway Walk Video", section: "Model Media", type: "file-or-url", required: false, searchable: false },
  { id: "model_campaign_links", label: "Published Campaign Links", section: "Model Media", type: "url-list", required: false, searchable: false },
]);

export const SINGER_FIELDS = byTalentType("Singer", [
  { id: "singer_category", label: "Singing Category", section: "Singer Profile", type: "select", required: true, searchable: true, options: ["Solo Artist", "Backing Vocalist", "Musical Theatre Singer", "Worship Singer", "Pop Singer", "R&B Singer", "Classical Singer", "Jazz Singer", "Rap / Spoken Word", "Other"] },
  { id: "singer_vocal_range", label: "Vocal Range", section: "Singer Profile", type: "select", required: false, searchable: true, options: ["Soprano", "Mezzo-Soprano", "Alto", "Tenor", "Baritone", "Bass", "Other"] },
  { id: "singer_genres", label: "Music Genres", section: "Singer Profile", type: "multi-select", required: false, searchable: true, optionSource: "music_genres" },
  { id: "singer_can_harmonise", label: "Can Harmonise", section: "Singer Profile", type: "boolean", required: false, searchable: true },
  { id: "singer_sight_read", label: "Can Sight-Read Music", section: "Singer Profile", type: "boolean", required: false, searchable: true },
...
export const DANCER_FIELDS = byTalentType("Dancer", [
  { id: "dancer_primary_style", label: "Primary Dance Style", section: "Dancer Profile", type: "select", required: true, searchable: true, optionSource: "dance_styles" },
  { id: "dancer_additional_styles", label: "Additional Dance Styles", section: "Dancer Profile", type: "multi-select", required: false, searchable: true, optionSource: "dance_styles" },
  { id: "dancer_training_school", label: "Dance Training School / Academy", section: "Dancer Profile", type: "text", required: false, searchable: true },
  { id: "dancer_choreography_experience", label: "Choreography Experience", section: "Dancer Profile", type: "boolean", required: false, searchable: true },
  { id: "dancer_partner_work", label: "Partner Work Experience", section: "Dancer Profile", type: "boolean", required: false, searchable: true },
...
export const VOICE_ARTIST_FIELDS = byTalentType("Voice Artist", [
  { id: "voice_work_type", label: "Voice Work Type", section: "Voice Artist Profile", type: "multi-select", required: true, searchable: true, options: ["Commercial Voiceover", "Animation", "Audiobook", "Narration", "Dubbing", "Radio", "Podcast", "Video Games", "E-learning", "Corporate", "Other"] },
  { id: "voice_age_range", label: "Voice Age Range", section: "Voice Artist Profile", type: "text", required: false, searchable: true },
  { id: "voice_natural_accent", label: "Natural Accent", section: "Voice Artist Profile", type: "text", required: false, searchable: true },
  { id: "voice_performed_accents", label: "Performed Accents", section: "Voice Artist Profile", type: "multi-select", required: false, searchable: true, optionSource: "accents" },
  { id: "voice_home_studio", label: "Home Studio Available", section: "Voice Artist Profile", type: "boolean", required: false, searchable: true },
  { id: "voice_equipment_quality", label: "Recording Equipment Quality", section: "Voice Artist Profile", type: "select", required: false, searchable: true, options: ["Basic", "Semi-professional", "Professional"] },
  { id: "voice_remote_recording", label: "Remote Recording Available", section: "Voice Artist Profile", type: "boolean", required: false, searchable: true },
  { id: "voice_live_directed_sessions", label: "Live Directed Sessions Available", section: "Voice Artist Profile", type: "boolean", required: false, searchable: true },
  { id: "voice_audio_editing", label: "Editing / Clean Audio Delivery", section: "Voice Artist Profile", type: "boolean", required: false, searchable: true },
  { id: "voice_languages", label: "Languages for Voice Work", section: "Voice Artist Profile", type: "multi-select", required: false, searchable: true, optionSource: "languages" },
  { id: "voice_reel", label: "Voice Reel", section: "Voice Artist Media", type: "file-or-url", required: false, searchable: false },
  { id: "voice_character_demo", label: "Character Demo Reel", section: "Voice Artist Media", type: "file-or-url", required: false, searchable: false },
  { id: "voice_narration_sample", label: "Narration Sample", section: "Voice Artist Media", type: "file-or-url", required: false, searchable: false },
]);

export const PRESENTER_FIELDS = byTalentType("Presenter / Host", [
  { id: "presenter_type", label: "Presenter Type", section: "Presenter Profile", type: "select", required: true, searchable: true, options: ["TV Presenter", "Event Host", "Red Carpet Host", "Corporate Host", "Interviewer", "Live Stream Host", "Radio Presenter", "Podcast Host", "Other"] },
  { id: "presenter_comfort", label: "Comfortable With", section: "Presenter Profile", type: "multi-select", required: false, searchable: true, options: ["Autocue", "Live Audience", "Interview Format", "Scripted Delivery", "Improvised Delivery", "Brand Hosting", "Panel Moderation"] },
  { id: "presenter_languages", label: "Languages for Presentation", section: "Presenter Profile", type: "multi-select", required: false, searchable: true, optionSource: "languages" },
  { id: "presenter_broadcast_experience", label: "Broadcast Experience", section: "Presenter Profile", type: "boolean", required: false, searchable: true },
  { id: "presenter_event_experience", label: "Event Hosting Experience", section: "Presenter Profile", type: "boolean", required: false, searchable: true },
  { id: "presenter_notable_clients", label: "Notable Shows / Events / Clients", section: "Presenter Profile", type: "textarea", required: false, searchable: false },
  { id: "presenter_reel", label: "Presenter Reel", section: "Presenter Media", type: "file-or-url", required: false, searchable: false },
  { id: "presenter_hosting_clips", label: "Hosting Clips", section: "Presenter Media", type: "multi-file-or-url", required: false, searchable: false },
  { id: "presenter_interview_samples", label: "Interview Samples", section: "Presenter Media", type: "multi-file-or-url", required: false, searchable: false },
]);

export const EXTRA_FIELDS = byTalentType("Extra / Supporting Artist", [
  { id: "extra_experience", label: "Background Artist Experience", section: "Extra Profile", type: "boolean", required: false, searchable: true },
  { id: "extra_open_to", label: "Open To", section: "Extra Profile", type: "multi-select", required: false, searchable: true, options: ["Film", "TV", "Commercials", "Crowd Scenes", "Featured Extra Roles", "Stand-in Work"] },
  { id: "extra_driving_licence", label: "Driving Licence", section: "Extra Profile", type: "boolean", required: false, searchable: true },
  { id: "extra_own_vehicle", label: "Own Vehicle", section: "Extra Profile", type: "boolean", required: false, searchable: true },
  { id: "extra_period_costume", label: "Comfortable with Period Costume", section: "Extra Profile", type: "boolean", required: false, searchable: true },
  { id: "extra_special_look", label: "Special Look / Character Type", section: "Extra Profile", type: "text", required: false, searchable: true },
  { id: "extra_uniform_roles", label: "Comfortable with Uniformed Roles", section: "Extra Profile", type: "boolean", required: false, searchable: true },
  { id: "extra_long_shoot_days", label: "Comfortable with Long Shoot Days", section: "Extra Profile", type: "boolean", required: false, searchable: true },
]);

export const MUSICIAN_FIELDS = byTalentType("Musician", [
  { id: "musician_primary_instrument", label: "Primary Instrument", section: "Musician Profile", type: "text", required: true, searchable: true, optionSource: "instruments" },
  { id: "musician_additional_instruments", label: "Additional Instruments", section: "Musician Profile", type: "multi-select", required: false, searchable: true, optionSource: "instruments" },
  { id: "musician_genres", label: "Music Genres", section: "Musician Profile", type: "multi-select", required: false, searchable: true, optionSource: "music_genres" },
  { id: "musician_sight_reading", label: "Sight-Reading Ability", section: "Musician Profile", type: "boolean", required: false, searchable: true },
  { id: "musician_improvisation", label: "Improvisation Ability", section: "Musician Profile", type: "boolean", required: false, searchable: true },
  { id: "musician_live_gig_experience", label: "Live Gig Experience", section: "Musician Profile", type: "boolean", required: false, searchable: true },
...
export const CREATOR_FIELDS = byTalentType("Content Creator", [
  { id: "creator_content_type", label: "Content Type", section: "Creator Profile", type: "multi-select", required: true, searchable: true, options: ["Lifestyle", "Beauty", "Fashion", "Comedy", "Music", "Education", "Entertainment", "Family", "Fitness", "Other"] },
  { id: "creator_platforms", label: "Primary Platforms", section: "Creator Profile", type: "multi-select", required: false, searchable: true, options: ["Instagram", "TikTok", "YouTube", "Facebook", "Twitch", "Other"] },
  { id: "creator_audience_size", label: "Audience Size", section: "Creator Profile", type: "text", required: false, searchable: true },
  { id: "creator_engagement_rate", label: "Average Engagement Rate", section: "Creator Profile", type: "text", required: false, searchable: true },
  { id: "creator_brand_collabs", label: "Brand Collaboration Experience", section: "Creator Profile", type: "boolean", required: false, searchable: true },
  { id: "creator_ugc_experience", label: "UGC Experience", section: "Creator Profile", type: "boolean", required: false, searchable: true },
  { id: "creator_editing_skills", label: "Editing Skills", section: "Creator Profile", type: "boolean", required: false, searchable: true },
  { id: "creator_livestream_experience", label: "Livestream Experience", section: "Creator Profile", type: "boolean", required: false, searchable: true },
  { id: "creator_niche", label: "Niche / Audience Demographic", section: "Creator Profile", type: "textarea", required: false, searchable: true },
  { id: "creator_reel", label: "Content Reel", section: "Creator Media", type: "file-or-url", required: false, searchable: false },
  { id: "creator_social_links", label: "Social Profile Links", section: "Creator Media", type: "url-list", required: false, searchable: false },
  { id: "creator_campaign_examples", label: "Brand Campaign Examples", section: "Creator Media", type: "url-list", required: false, searchable: false },
]);

export const COMEDIAN_FIELDS = byTalentType("Comedian", [
  { id: "comedian_type", label: "Comedy Type", section: "Comedian Profile", type: "multi-select", required: true, searchable: true, options: ["Stand-up", "Sketch", "Character Comedy", "Improvisation", "Writing", "Hosting", "Other"] },
...
export const STUNT_FIELDS = byTalentType("Stunt Performer", [
  { id: "stunt_speciality", label: "Stunt Speciality", section: "Stunt Profile", type: "multi-select", required: true, searchable: true, options: ["Fight Performance", "Falls", "Driving", "Horse Work", "Fire Stunts", "Wire Work", "Water Work", "Weapons Handling", "Other"] },
  { id: "stunt_certifications", label: "Certifications / Safety Qualifications", section: "Stunt Profile", type: "textarea", required: false, searchable: true },
  { id: "stunt_martial_arts", label: "Martial Arts Background", section: "Stunt Profile", type: "text", required: false, searchable: true },
  { id: "stunt_weapons_training", label: "Weapons Training", section: "Stunt Profile", type: "boolean", required: false, searchable: true },
  { id: "stunt_driving_licence_types", label: "Driving Class / Licence Types", section: "Stunt Profile", type: "text", required: false, searchable: true },
