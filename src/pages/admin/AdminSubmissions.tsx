 ...
 const stats = [
   { label: "Total Submissions", value: "1,847", color: "foreground" },
   { label: "Approved", value: "1,592", color: "success" },
   { label: "Under Review", value: "243", color: "warning" },
   { label: "Flagged", value: "12", color: "destructive" },
 ];
