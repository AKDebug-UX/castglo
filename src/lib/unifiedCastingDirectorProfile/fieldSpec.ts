...
const CORE_FIELDS: CastingDirectorFieldSpec[] = [
  ...
  { id: "verified_badge", label: "Verified Badge", section: "Credibility / Trust", type: "boolean", required: false, searchable: true },
...
const HIRING_TOOL_FIELDS: CastingDirectorFieldSpec[] = [
  ...
  { id: "enable_manage_applicants", label: "Manage Applicants", section: "Hiring Manager Tools", type: "boolean", required: false, searchable: false },
  { id: "enable_switch_between_roles", label: "Switch Between Roles", section: "Hiring Manager Tools", type: "boolean", required: false, searchable: false },
  { id: "enable_filter_applicants", label: "Filter Applicants", section: "Hiring Manager Tools", type: "boolean", required: false, searchable: false },
  { id: "enable_matched_applicants", label: "Matched Applicants", section: "Hiring Manager Tools", type: "boolean", required: false, searchable: false },
  { id: "enable_bulk_actions", label: "Bulk Actions", section: "Hiring Manager Tools", type: "boolean", required: false, searchable: false },
  { id: "enable_folders", label: "Folders", section: "Hiring Manager Tools", type: "boolean", required: false, searchable: false },
  { id: "enable_audition_requests", label: "Audition Requests", section: "Hiring Manager Tools", type: "boolean", required: false, searchable: false },
  { id: "enable_private_notes", label: "Notes", section: "Hiring Manager Tools", type: "boolean", required: false, searchable: false },
  { id: "enable_messaging", label: "Messaging", section: "Hiring Manager Tools", type: "boolean", required: false, searchable: false },
  { id: "enable_collaborators", label: "Collaborators", section: "Hiring Manager Tools", type: "boolean", required: false, searchable: false },
  { id: "enable_role_management", label: "Role Management", section: "Hiring Manager Tools", type: "boolean", required: false, searchable: false },
  ...
  { id: "match_engine_enabled", label: "Match Engine Enabled", section: "Applicant Management", type: "boolean", required: false, searchable: false },
...
const PROJECT_FIELDS: CastingDirectorFieldSpec[] = [
  ...
  { id: "remote_option_available", label: "Remote Option Available", section: "Project / Casting Call", type: "boolean", required: false, searchable: true },

  { id: "audition_required", label: "Audition Required", section: "Project / Casting Call", type: "boolean", required: false, searchable: true },
  { id: "interview_required", label: "Interview Required", section: "Project / Casting Call", type: "boolean", required: false, searchable: true },
...
const ROLE_FIELDS: CastingDirectorFieldSpec[] = [
  ...
  { id: "nudity_required", label: "Nudity Required", section: "Role Management", type: "boolean", required: false, searchable: true },
  ...
  { id: "preaudition_request_custom_video", label: "Request Custom Video", section: "Pre-Audition Workflow", type: "boolean", required: false, searchable: false },
  { id: "preaudition_request_custom_audio", label: "Request Custom Audio", section: "Pre-Audition Workflow", type: "boolean", required: false, searchable: false },
  { id: "preaudition_request_additional_media", label: "Request Additional Media", section: "Pre-Audition Workflow", type: "boolean", required: false, searchable: false },
  { id: "preaudition_send_message", label: "Send Message to Talent", section: "Pre-Audition Workflow", type: "boolean", required: false, searchable: false },
  { id: "preaudition_questions_enabled", label: "Enable Pre-Audition Questions", section: "Pre-Audition Workflow", type: "boolean", required: false, searchable: false },
  ...
  { id: "preaudition_question_required", label: "Required / Optional Toggle", section: "Pre-Audition Form", type: "boolean", required: false, searchable: false },
...
const MARKETPLACE_FIELDS: CastingDirectorFieldSpec[] = [
  ...
  { id: "instant_posting", label: "Instant Posting", section: "Marketplace / Commercial", type: "boolean", required: false, searchable: true },
  { id: "featured_posting", label: "Featured Posting", section: "Marketplace / Commercial", type: "boolean", required: false, searchable: true },
  { id: "urgent_hiring_badge", label: "Urgent Hiring Badge", section: "Marketplace / Commercial", type: "boolean", required: false, searchable: true },
  { id: "priority_matched_applicants", label: "Priority Matched Applicants", section: "Marketplace / Commercial", type: "boolean", required: false, searchable: true },
  { id: "extended_visibility", label: "Extended Visibility", section: "Marketplace / Commercial", type: "boolean", required: false, searchable: true },
  { id: "featured_role_highlight", label: "Featured Role Highlight", section: "Marketplace / Commercial", type: "boolean", required: false, searchable: true },
  { id: "social_promotion_boost", label: "Social Promotion Boost", section: "Marketplace / Commercial", type: "boolean", required: false, searchable: true },
  ...
  { id: "premium_analytics", label: "Premium Analytics", section: "Marketplace / Commercial", type: "boolean", required: false, searchable: true },
