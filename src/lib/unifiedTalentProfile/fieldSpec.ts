...
export const ACTOR_FIELDS = byTalentType("Actor / Performer", [
  ...
  { id: "actor_training", label: "Formal Acting / Performance Training", section: "Actor Details", type: "boolean", required: false, searchable: true },
...
export const MODEL_FIELDS = byTalentType("Model", [
  ...
  { id: "model_open_hair_changes", label: "Open to Hair Styling Changes", section: "Model Details", type: "boolean", required: false, searchable: true },
...
export const SINGER_FIELDS = byTalentType("Singer", [
  ...
  { id: "singer_can_harmonise", label: "Can Harmonise", section: "Singer Details", type: "boolean", required: false, searchable: true },
  { id: "singer_sight_read", label: "Can Sight-Read Music", section: "Singer Details", type: "boolean", required: false, searchable: true },
  { id: "singer_songwriting", label: "Songwriting Ability", section: "Singer Details", type: "boolean", required: false, searchable: true },
  { id: "singer_live_experience", label: "Live Performance Experience", section: "Singer Details", type: "boolean", required: false, searchable: true },
  { id: "singer_studio_experience", label: "Studio Recording Experience", section: "Singer Details", type: "boolean", required: false, searchable: true },
...
export const DANCER_FIELDS = byTalentType("Dancer", [
  ...
  { id: "dancer_choreography_experience", label: "Choreography Experience", section: "Dancer Details", type: "boolean", required: false, searchable: true },
  { id: "dancer_partner_work", label: "Partner Work Experience", section: "Dancer Details", type: "boolean", required: false, searchable: true },
  { id: "dancer_teaching_experience", label: "Teaching Experience", section: "Dancer Details", type: "boolean", required: false, searchable: true },
  { id: "dancer_live_experience", label: "Live Performance Experience", section: "Dancer Details", type: "boolean", required: false, searchable: true },
  { id: "dancer_touring_experience", label: "Touring Experience", section: "Dancer Details", type: "boolean", required: false, searchable: true },
...
export const VOICE_ARTIST_FIELDS = byTalentType("Voice Artist", [
  ...
  { id: "voice_remote_recording", label: "Remote Recording Available", section: "Voice Artist Details", type: "boolean", required: false, searchable: true },
  { id: "voice_live_directed_sessions", label: "Live Directed Sessions Available", section: "Voice Artist Details", type: "boolean", required: false, searchable: true },
  { id: "voice_audio_editing", label: "Editing / Clean Audio Delivery", section: "Voice Artist Details", type: "boolean", required: false, searchable: true },
...
export const PRESENTER_FIELDS = byTalentType("Presenter / Host", [
  ...
  { id: "presenter_broadcast_experience", label: "Broadcast Experience", section: "Presenter Details", type: "boolean", required: false, searchable: true },
...
export const EXTRA_FIELDS = byTalentType("Extra / Supporting Artist", [
  { id: "extra_experience", label: "Background Artist Experience", section: "Extra Details", type: "boolean", required: false, searchable: true },
  ...
  { id: "extra_driving_licence", label: "Driving Licence", section: "Extra Details", type: "boolean", required: false, searchable: true },
  { id: "extra_own_vehicle", label: "Own Vehicle", section: "Extra Details", type: "boolean", required: false, searchable: true },
  { id: "extra_period_costume", label: "Comfortable with Period Costume", section: "Extra Details", type: "boolean", required: false, searchable: true },
  { id: "extra_special_look", label: "Special Look / Character Type", section: "Extra Details", type: "text", required: false, searchable: true },
  { id: "extra_uniform_roles", label: "Comfortable with Uniformed Roles", section: "Extra Details", type: "boolean", required: false, searchable: true },
  { id: "extra_long_shoot_days", label: "Comfortable with Long Shoot Days", section: "Extra Details", type: "boolean", required: false, searchable: true },
]);
...
export const MUSICIAN_FIELDS = byTalentType("Musician", [
  ...
  { id: "musician_sight_reading", label: "Sight-Reading Ability", section: "Musician Details", type: "boolean", required: false, searchable: true },
  { id: "musician_improvisation", label: "Improvisation Ability", section: "Musician Details", type: "boolean", required: false, searchable: true },
  { id: "musician_live_gig_experience", label: "Live Gig Experience", section: "Musician Details", type: "boolean", required: false, searchable: true },
  { id: "musician_studio_session_experience", label: "Studio Session Experience", section: "Musician Details", type: "boolean", required: false, searchable: true },
  { id: "musician_touring_experience", label: "Touring Experience", section: "Musician Details", type: "boolean", required: false, searchable: true },
  { id: "musician_composition_skills", label: "Composition / Arrangement Skills", section: "Musician Details", type: "boolean", required: false, searchable: true },
...
export const CREATOR_FIELDS = byTalentType("Content Creator", [
  ...
  { id: "creator_brand_collabs", label: "Brand Collaboration Experience", section: "Creator Details", type: "boolean", required: false, searchable: true },
  { id: "creator_ugc_experience", label: "UGC Experience", section: "Creator Details", type: "boolean", required: false, searchable: true },
  { id: "creator_editing_skills", label: "Editing Skills", section: "Creator Details", type: "boolean", required: false, searchable: true },
...
export const COMEDIAN_FIELDS = byTalentType("Comedian", [
  ...
  { id: "comedian_live_experience", label: "Live Comedy Experience", section: "Comedian Details", type: "boolean", required: false, searchable: true },
  { id: "comedian_writing_experience", label: "Writing Experience", section: "Comedian Details", type: "boolean", required: false, searchable: true },
  { id: "comedian_improv_experience", label: "Improv Experience", section: "Comedian Details", type: "boolean", required: false, searchable: true },
  ...
  { id: "comedian_clean_sets", label: "Clean / Family-Friendly Sets Available", section: "Comedian Details", type: "boolean", required: false, searchable: true },
...
export const STUNT_FIELDS = byTalentType("Stunt Performer", [
  ...
  { id: "stunt_weapons_training", label: "Weapons Training", section: "Stunt Details", type: "boolean", required: false, searchable: true },
  ...
  { id: "stunt_swimming_ability", label: "Swimming Ability", section: "Stunt Details", type: "boolean", required: false, searchable: true },
  { id: "stunt_rigging_experience", label: "Rigging / Harness Experience", section: "Stunt Details", type: "boolean", required: false, searchable: true },
  { id: "stunt_mocap_experience", label: "Motion Capture Experience", section: "Stunt Details", type: "boolean", required: false, searchable: true },
