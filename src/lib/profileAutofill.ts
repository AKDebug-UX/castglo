  ...
  fieldSpecs.forEach((field) => {
    ...
    switch (field.type) {
      case "text":
        ...
        else if (field.id === "chest_bust_measurement") dummyData[field.id] = "96";
        else if (field.id === "waist_measurement") dummyData[field.id] = "81";
        else if (field.id === "hip_measurement") dummyData[field.id] = "98";
        else if (field.id === "inside_leg_measurement") dummyData[field.id] = "81";
        else if (field.id === "model_chest_bust") dummyData[field.id] = "90";
        else if (field.id === "model_waist") dummyData[field.id] = "74";
        else if (field.id === "model_hips") dummyData[field.id] = "92";
